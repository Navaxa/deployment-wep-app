<?php
  ...
  if (!isset($_GET['d'])) {
    header('Location:centro-donativo.php');
  }
  $data = $usuarios -> get_data_donaction_by_id($_GET['d']);
        if(count($data)) {
         ...
         /* $diffTime = strtotime($dateTime) - time();
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link active" style="cursor: pointer" href="centro-donativo.php">
                <svg
                  width="1em"
                  height="1em"
                  viewBox="0 0 16 16"
                ...
                <div class="container d-flex align-items-center justify-content-center">
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="col-md-8">
                            ...
                            <h3 class="text-center mb-5">Programa tu recolección de donación   
                            </h3>
                            <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing.</p> -->
                            <form action="programar.php?d=<?php echo $_GET['d']; ?>" method="POST" class="row">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text"class="form-control" value="<?php echo $producto; ?>" name="product" placeholder="Producto" disabled>
                                </div>
                                <label>Unidades en Kg</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend input-group-text">
                                    ...
                                    <input type="number"class="form-control" value="<?php echo $units; ?>" name="weight" step="0.01" placeholder="Unidades en Kilos" disabled>
                                </div>
                                <label>Fecha limite de vencimiento</label>
                                <div class="input-group mb-3">
                                  <div class="input-group-prepend input-group-text">
                                  ...
                                  <input type="date"class="form-control" name="date" value="<?php echo $fecha;?>" placeholder="Unidades en Kilos" disabled>
                              </div>
                                <label for="exampleFormControlSelect1">Causa de la donación</label>

                              <div class="form-group input-group">
                              <input type="text"class="form-control" name="cause" value="<?php echo $causa;?>" disabled>
                              </div>

                              <label>Nombre de quien recoge la donación</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend input-group-text">
                                    ...
                                    <input type="text"class="form-control" name="name-recolector" placeholder="Nombre completo" required>
                                </div>
                                <label>Selecciona la fecha de recolección</label>
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="date"class="form-control" name="date-recolection" required max="<?php echo $fecha;?>"  min="<?php echo $currentDateTime;?>">
                                  
                              </div>
                                <button class="btn btn-outline-primary btn-lg btn-block">Programar</button>
                            </form>
                            <!-- <a href="#" class="btn btn-primary btn-lg mt-5 btn-block">¿Cómo llego?</a> -->
                        <a href="centro-donativo.php" class="btn btn-danger btn-lg mt-5 btn-block">Cancelar</a>
